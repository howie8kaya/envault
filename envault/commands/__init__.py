"""envault.commands — public re-exports for all command modules."""
...
from envault.commands.tags import add_tag, remove_tag, list_tags
from envault.commands.history import record_change, get_history
from envault.commands.expire import set_expiry, get_expiry, list_expiring
from envault.commands.pin import pin_secret, unpin_secret, is_pinned
from envault.commands.watch import WatchEvent
...
from envault.commands.lock import lock_vault, unlock_vault, get_session_passphrase
...
from envault.commands.alias import set_alias, resolve_alias
from envault.commands.ttl import set_ttl, get_ttl, is_expired
from envault.commands.access import set_access, get_access, revoke_access
from envault.commands.deps import add_dependency, remove_dependency, list_dependencies
from envault.commands.group import add_to_group, remove_from_group, list_groups
...
__all__ = [
    ...
    "pin_secret", "unpin_secret", "is_pinned",
    "WatchEvent",
    "set_note", "get_note",
    "generate_secret", "list_charsets",
    "fmt_vault",
    "compare_vaults",
    "lock_vault", "unlock_vault", "get_session_passphrase",
    "create_backup", "restore_backup", "backup_info",
    "merge_vaults", "format_merge_results",
    "set_alias", "resolve_alias",
    "set_ttl", "get_ttl", "is_expired",
    "set_access", "get_access", "revoke_access",
